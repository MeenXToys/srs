...
<body>
  ...
  <div style="max-width:1100px;margin:50px auto;">
    ...
    <div class="search-bar">
      <select id="semesterSelect"><option value="">-- Select Semester --</option><?php for($i=1;$i<=5;$i++): ?><option value="Sem<?=$i?>">SEMESTER <?=$i?></option><?php endfor; ?></select>
      ...
      <select id="numClassSelect"><option value="">-- No. Class --</option><?php for($i=1;$i<=2;$i++): ?><option value="<?=$i?>"><?=$i?></option><?php endfor; ?></select>
...
function showTimetable(){
  ...
  document.getElementById('timetableImage').src = 'img/Timetable/' + semester + '_' + cls + num + '.png';
}
function saveImage(){

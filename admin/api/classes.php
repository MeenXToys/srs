...
/* ---------------- single-row filters (updated) ---------------- */
.filters-row{
  display:flex;
  gap:12px;
  align-items:center;
  flex-wrap:nowrap;       /* keep one row where possible */
  width:100%;
  margin-bottom:14px;
}
/* search box (left) */
.filters-row .search-box{ flex:0 0 320px; min-width:220px; }
/* per dropdown small */
.filters-row .small{ flex:0 0 64px; max-width:64px; text-align:center; }
/* department select takes remaining space */
.filters-row .dept{ flex:1 1 360px; min-width:200px; }
/* semester made shorter per request */
.filters-row .sem{ flex:0 0 120px; min-width:120px; max-width:140px; text-align:center; }
/* actions (search & clear) inline */
.filters-row .search-actions{
  margin-left:6px;
  display:flex;
  gap:8px;
  align-items:center;
...
@media(max-width:980px){
  ...
  .filters-row .search-box{ flex:1 1 100%; min-width:160px; }
  .filters-row .dept{ flex:1 1 100%; min-width:160px; }
  .filters-row .sem{ flex:0 0 120px; }
  .filters-row .search-actions{ width:100%; justify-content:flex-end; margin-left:0; }
}
